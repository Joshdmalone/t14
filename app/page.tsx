    ...
    <div className="min-h-screen bg-gray-50">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Visual representation of all scheduled events and their 15-mile radius zones</p>
                </div>
                <div className="flex items-center space-x-2">
                  <span className="text-sm text-gray-600">
                    Showing {displayedEvents.length} {showActiveOnly ? 'active' : 'total'} events
                  </span>
                </div>
              </div>
                    ...
                    {displayedEvents.map(event => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="absolute left-full ml-2 top-0 bg-white rounded-lg shadow-lg p-3 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap z-10">
                ...
                <div className="absolute bottom-4 left-4 bg-white rounded-lg shadow-lg p-4 space-y-2">
                  ...
                  {clients.filter(c => showActiveOnly ? c.isActive : true).map(client => (
                    <div key={client.id} className="flex items-center space-x-2">
                      ...
                      {!client.isActive && <span className="text-xs text-gray-400">(Inactive)</span>}
                    </div>
                  ))}
            ...
            <div className="grid grid-cols-1 gap-4">
              {filteredEvents.length === 0 ? (
                ...
                filteredEvents.map(event => {
                  ...
                  return (
                    <div key={event.id} className={`bg-white rounded-lg shadow-sm border p-6 ${hasConflicts ? 'border-red-300' : 'border-gray-200'} ${!event.isActive ? 'opacity-60' : ''}`}>
        ...
        {activeTab === 'clients' && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {clients.filter(c => showActiveOnly ? c.isActive : true).map(client => {
              ...
              return (
                <div key={client.id} className={`bg-white rounded-lg shadow-sm border border-gray-200 p-6 ${!client.isActive ? 'opacity-60' : ''}`}>
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center space-x-3">
                      <div
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
                <p className="text-xs text-gray-500 mt-1">5-digit zip code for territory validation</p>
              </div>
      ...
      {showImportModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 w-full max-w-lg p-6 m-4">
            <div className="flex items-center justify-between mb-4">
